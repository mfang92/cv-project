...
from modal import Image, Queue, Stub, forward, Mount

args: Any = {'cpu': 8, 'memory': 32768, 'gpu': 'T4', 'timeout': 3600}

dirVSCode = "" # change! should be directory you want to open with modal
...
@stub.function(cpu=args["cpu"], memory=args["memory"], gpu=args["gpu"], timeout=args["timeout"],
               mounts = [Mount.from_local_dir(dirVSCode, remote_path="/home/coder")])
def run_jupyter():
    os.chdir("/home/coder")
